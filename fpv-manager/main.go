...
func (a *App) registerRoutes(mux *http.ServeMux) {
	...
	mux.HandleFunc("POST /frames/{id}/duplicate", a.handleFrameDuplicate)
	...
	mux.HandleFunc("POST /fcs/{id}/duplicate", a.handleFCDuplicate)
	...
	mux.HandleFunc("POST /escs/{id}/duplicate", a.handleESCDuplicate)
	...
	mux.HandleFunc("POST /motors/{id}/duplicate", a.handleMotorDuplicate)
	...
	mux.HandleFunc("POST /vtx/{id}/duplicate", a.handleVTXDuplicate)
